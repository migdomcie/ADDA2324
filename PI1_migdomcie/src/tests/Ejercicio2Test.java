...
public class Ejercicio2Test {
	...
	public static void main(String[] args) {
		...
		for(IntPair p: ls) {
			System.out.println("2.1) recursivo:\n" + Ejercicio2.solucionRec(p.first(), p.second()));
			System.out.println("2.2) recursivo final:\n" + Ejercicio2.solucionRecFinal(p.first(), p.second()));
			System.out.println("2.3) iterativo:\n" + Ejercicio2.solucionIt(p.first(), p.second()));
			System.out.println("2.4) funcional:\n" + Ejercicio2.solucionFunc(p.first(), p.second()) + "\n");
		}
	}
