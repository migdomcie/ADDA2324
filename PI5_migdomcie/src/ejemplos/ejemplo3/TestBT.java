...
public class TestBT {
	...
	public static void main(String[] args) {
		...
		DatosAlumnos.iniDatos("ficheros/ejemplos/Ejemplo3DatosEntrada2.txt");
		...
		BT<AlumnosVertex,AlumnosEdge,SolucionAlumnos>alg_bt = BT.of(graph, null, path.getWeight(), path, true);
		...
		if(outGraph!=null) {
			...
			GraphColors.toDot(outGraph, "ficheros_generados/AlumnosBTGraph2.gv", 
					v -> v.toGraph(),
					e -> e.action().toString(), 
