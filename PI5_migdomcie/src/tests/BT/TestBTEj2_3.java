...
public class TestBTEj2_3 {

	public static void main(String[] args) {

		DatosProductosNavidad.iniDatos("ficheros/ejercicios/Ejercicio2DatosEntrada3.txt");
...
//		path = null;
		...
		BT<ProductosNavidadVertex,ProductosNavidadEdge,SolucionProductosNavidad>alg_bt = BT.of(graph, null, null, null, true);
		...
		if(outGraph!=null) {
			...
			GraphColors.toDot(outGraph, "ficheros_generados/ProductosNavidadBTGraph3.gv", 
					v -> v.toString(),
					e -> e.action().toString(), 
