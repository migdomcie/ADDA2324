...
public class TestBTEj3_1 {

	public static void main(String[] args) {

		DatosProductosDistribucion.iniDatos("ficheros/ejercicios/Ejercicio3DatosEntrada1.txt");
...
//		path = null;
		...
		BT<ProductosDistribucionVertex,ProductosDistribucionEdge,SolucionProductosDistribucion>alg_bt = BT.of(graph, null, path.getWeight(), path, true);
		...
		if(outGraph!=null) {
			...
			GraphColors.toDot(outGraph, "ficheros_generados/ProductosDistribucionBTGraph1.gv", 
					v -> v.toString(),
					e -> e.action().toString(), 
