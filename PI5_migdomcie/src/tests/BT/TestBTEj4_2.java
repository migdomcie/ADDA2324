...
public class TestBTEj4_2 {

	public static void main(String[] args) {

		DatosPersonas.iniDatos("ficheros/ejercicios/Ejercicio4DatosEntrada2.txt");
...
//		path = null;
		...
		BT<PersonasVertex,PersonasEdge,SolucionPersonas>alg_bt = BT.of(graph, null, null, null, true);
		...
		if(outGraph!=null) {
			...
			GraphColors.toDot(outGraph, "ficheros_generados/PersonasBTGraph2.gv", 
					v -> v.toString(),
					e -> e.action().toString(), 
