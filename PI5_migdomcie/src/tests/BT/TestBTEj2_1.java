...
public class TestBTEj2_1 {

	public static void main(String[] args) {

		DatosProductosNavidad.iniDatos("ficheros/ejercicios/Ejercicio2DatosEntrada1.txt");
...
//		path = null;
		...
		if(outGraph!=null) {
			...
			GraphColors.toDot(outGraph, "ficheros_generados/ProductosNavidadBTGraph1.gv", 
					v -> v.toString(),
					e -> e.action().toString(), 
