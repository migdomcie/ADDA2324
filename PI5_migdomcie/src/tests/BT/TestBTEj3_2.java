...
public class TestBTEj3_2 {

	public static void main(String[] args) {

		DatosProductosDistribucion.iniDatos("ficheros/ejercicios/Ejercicio3DatosEntrada2.txt");
...
//		path = null;
		...
		if(outGraph!=null) {
			...
			GraphColors.toDot(outGraph, "ficheros_generados/ProductosDistribucionBTGraph2.gv", 
					v -> v.toString(),
					e -> e.action().toString(), 
