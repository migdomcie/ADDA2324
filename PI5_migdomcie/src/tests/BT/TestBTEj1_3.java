...
public class TestBTEj1_3 {

	public static void main(String[] args) {

		DatosVerduras.iniDatos("ficheros/ejercicios/Ejercicio1DatosEntrada3.txt");
...
//		path = null;
	...
	//	BT<VerdurasVertex,VerdurasEdge,SolucionVerduras>alg_bt = BT.of(graph, null, path.getWeight(), path, true);
		...
		if(outGraph!=null) {
			...
			GraphColors.toDot(outGraph, "ficheros_generados/VerdurasBTGraph3.gv", 
					v -> v.toString(),
					e -> e.action().toString(), 
