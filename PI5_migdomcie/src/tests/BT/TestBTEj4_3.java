...
public class TestBTEj4_3 {

	public static void main(String[] args) {

		DatosPersonas.iniDatos("ficheros/ejercicios/Ejercicio4DatosEntrada3.txt");
...
//		path = null;
		...
		if(outGraph!=null) {
			...
			GraphColors.toDot(outGraph, "ficheros_generados/PersonasBTGraph3.gv", 
					v -> v.toString(),
					e -> e.action().toString(), 
