...
public class TestAStarEj2_1 {

	public static void main(String[] args) {
		// Set up
		Locale.setDefault(Locale.of("en", "US"));

		String id_fichero = "Ejercicio2DatosEntrada1.txt";
...
//		System.out.println(gp_as);
		...
		GraphColors.toDot(aStar.outGraph(), "ficheros_generados/ProductosNavidadAStarGraph1.gv", 
					v -> v.toString(),
					e -> e.action().toString(), 
